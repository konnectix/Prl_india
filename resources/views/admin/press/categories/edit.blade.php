...
@section('title', 'Edit Press Category')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 mb-0">Edit Press Category</h1>
...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('admin.press.categories.update', $category) }}">
                    @csrf
                    @method('PUT')
    ...
    <div class="col-md-4">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p><strong>Articles Count:</strong> {{ $category->articles_count }}</p>
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <a href="{{ route('admin.press.categories.show', $category) }}" class="btn btn-info btn-sm mb-2 w-100">
                    <i class="fas fa-eye me-2"></i>View Category
                </a>
                <a href="{{ route('admin.press.articles.index', ['category_id' => $category->id]) }}" class="btn btn-success btn-sm w-100">

...
<head>
    ...
    <title>Admin Login - Premier Roadlines Limited</title>
...
<body>
    <div class="auth-container">
        <div class="auth-left">
            <div class="logo">
              <img src="{{ asset('assets/img/logo/logoprlindia.png') }}" alt="Premier Roadlines" style="max-width: 160px; height: auto;">
            </div>
            <h1>Welcome Back!</h1>
            <p>Access your admin dashboard to manage Premier Roadlines operations efficiently and maintain our commitment to excellence in logistics services.</p>
        </div>

...
<div class="content-wrapper">
    ...
    <section class="content">
        <div class="container-fluid">
            <form action="{{ route('admin.video.videos.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-8">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control @error('video_type') is-invalid @enderror" 
                                                ...
                                                <option value="external" {{ old('video_type') == 'external' ? 'selected' : '' }}>External URL</option>
                                            </select>
                                            @error('video_type')
                                                <span class="invalid-feedback">{{ $message }}</span>
                                            @enderror
                                ...
                                <div class="form-group video-input" id="vimeo_input" style="display: none;">
                                    ...
                                    <input type="url" class="form-control @error('vimeo_url') is-invalid @enderror" 
                                           id="vimeo_url" name="vimeo_url" value="{{ old('vimeo_url') }}" 
                    ...
                    <div class="col-md-4">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    @error('thumbnail')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                    <small class="form-text text-muted">Upload custom thumbnail (optional). For YouTube/Vimeo, thumbnail will be auto-generated if not provided.</small>
                                </div>
                        ...
                        <div class="card card-info">
                            ...
                            <div class="card-body">
                                ...
                                <div id="no_preview" class="text-center text-muted">
